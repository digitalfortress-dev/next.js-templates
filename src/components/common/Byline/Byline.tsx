export default function Byline({ className }: { className: string }) {
  return (
    ...
    >
      <div className="flex flex-col justify-between space-y-2 rounded-lg bg-primary p-3.5 lg:px-5 lg:py-3">
        <div className="flex items-center gap-x-1.5">
          <div className="text-sm text-gray-400">By</div>
          <a href="https://digitalfortress.dev" title="Vercel">
            <div className="w-16 text-primary hover:text-secondary">
              DF Logo
            </div>
          </a>
        </div>
        ...
        <div className="text-sm text-gray-400">
          <a
            ...
            href="https://github.com/digitalfortress-dev"
            target="_blank"
            rel="noreferrer"
          >
            View code
          ...
          <a
            className="underline decoration-dotted underline-offset-4 transition-colors hover:text-gray-300"
            href="https://digitalfortress.dev"
            target="_blank"
            rel="noreferrer"
          >
            deploy your own
